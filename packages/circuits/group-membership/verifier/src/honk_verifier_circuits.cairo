...
let modulus = modulus;
    ...
    // Prefill constants:
            ...
            circuit_inputs = circuit_inputs.next_span(HONK_SUMCHECK_SIZE_13_PUB_17_GRUMPKIN_CONSTANTS.span()); // in0 - in26
