...
pub fn run_GRUMPKIN_ZK_HONK_SUMCHECK_SIZE_18_PUB_17_circuit(p_public_inputs:Span<u256>,p_pairing_point_object:Span<u256>,p_public_inputs_offset:u384,libra_sum:u384,sumcheck_univariates_flat:Span<u256>,sumcheck_evaluations:Span<u256>,libra_evaluation:u384,tp_sum_check_u_challenges:Span<u128>,tp_gate_challenges:Span<u128>,tp_eta_1:u384,tp_eta_2:u384,tp_eta_3:u384,tp_beta:u384,tp_gamma:u384,tp_base_rlc:u384,tp_alphas:Span<u128>,tp_libra_challenge:u384, modulus:CircuitModulus)->(u384,u384) {
 ...
 // INPUT stack
	 ...
	 let (in313, in314) = (CE::<CI<313>> {}, CE::<CI<314>> {});
...
let t177 = circuit_sub(in265, in0); 
let t178 = circuit_mul(in247, t177); 
...
let t250 = circuit_sub(in266, in0); 
let t251 = circuit_mul(in248, t250); 
...
let t323 = circuit_sub(in267, in0); 
let t324 = circuit_mul(in249, t323); 
...
let t396 = circuit_sub(in268, in0); 
let t397 = circuit_mul(in250, t396); 
...
let t469 = circuit_sub(in269, in0); 
let t470 = circuit_mul(in251, t469); 
...
let t542 = circuit_sub(in270, in0); 
let t543 = circuit_mul(in252, t542); 
...
let t615 = circuit_sub(in271, in0); 
let t616 = circuit_mul(in253, t615); 
...
let t688 = circuit_sub(in272, in0); 
let t689 = circuit_mul(in254, t688); 
...
let t761 = circuit_sub(in273, in0); 
let t762 = circuit_mul(in255, t761); 
...
let t834 = circuit_sub(in274, in0); 
let t835 = circuit_mul(in256, t834); 
...
let t907 = circuit_sub(in275, in0); 
let t908 = circuit_mul(in257, t907); 
...
let t980 = circuit_sub(in276, in0); 
let t981 = circuit_mul(in258, t980); 
...
let t1003 = circuit_sub(in259, in8); 
let t1004 = circuit_mul(t997, t1003); 
let t1005 = circuit_sub(in259, in8); 
...
let t1010 = circuit_sub(in259, in9); 
let t1011 = circuit_mul(t1004, t1010); 
let t1012 = circuit_sub(in259, in9); 
...
let t1017 = circuit_sub(in259, in10); 
let t1018 = circuit_mul(t1011, t1017); 
let t1019 = circuit_sub(in259, in10); 
...
let t1024 = circuit_sub(in259, in11); 
let t1025 = circuit_mul(t1018, t1024); 
let t1026 = circuit_sub(in259, in11); 
...
let t1031 = circuit_sub(in259, in12); 
let t1032 = circuit_mul(t1025, t1031); 
let t1033 = circuit_sub(in259, in12); 
...
let t1038 = circuit_sub(in259, in13); 
let t1039 = circuit_mul(t1032, t1038); 
let t1040 = circuit_sub(in259, in13); 
...
let t1045 = circuit_sub(in259, in14); 
let t1046 = circuit_mul(t1039, t1045); 
let t1047 = circuit_sub(in259, in14); 
...
let t1053 = circuit_sub(in277, in0); 
let t1054 = circuit_mul(in259, t1053); 
...
let t1061 = circuit_mul(t988, in288); 
let t1062 = circuit_sub(in260, in7); 
let t1063 = circuit_mul(in0, t1062); 
let t1064 = circuit_sub(in260, in7); 
...
let t1069 = circuit_sub(in260, in0); 
let t1070 = circuit_mul(t1063, t1069); 
let t1071 = circuit_sub(in260, in0); 
...
let t1076 = circuit_sub(in260, in8); 
let t1077 = circuit_mul(t1070, t1076); 
let t1078 = circuit_sub(in260, in8); 
...
let t1083 = circuit_sub(in260, in9); 
let t1084 = circuit_mul(t1077, t1083); 
let t1085 = circuit_sub(in260, in9); 
...
let t1090 = circuit_sub(in260, in10); 
let t1091 = circuit_mul(t1084, t1090); 
let t1092 = circuit_sub(in260, in10); 
...
let t1097 = circuit_sub(in260, in11); 
let t1098 = circuit_mul(t1091, t1097); 
let t1099 = circuit_sub(in260, in11); 
...
let t1104 = circuit_sub(in260, in12); 
let t1105 = circuit_mul(t1098, t1104); 
let t1106 = circuit_sub(in260, in12); 
...
let t1111 = circuit_sub(in260, in13); 
let t1112 = circuit_mul(t1105, t1111); 
let t1113 = circuit_sub(in260, in13); 
...
let t1118 = circuit_sub(in260, in14); 
let t1119 = circuit_mul(t1112, t1118); 
let t1120 = circuit_sub(in260, in14); 
...
let t1126 = circuit_sub(in278, in0); 
let t1127 = circuit_mul(in260, t1126); 
...
let t1134 = circuit_mul(t1061, in288); 
let t1135 = circuit_sub(in261, in7); 
let t1136 = circuit_mul(in0, t1135); 
let t1137 = circuit_sub(in261, in7); 
...
let t1142 = circuit_sub(in261, in0); 
let t1143 = circuit_mul(t1136, t1142); 
let t1144 = circuit_sub(in261, in0); 
...
let t1149 = circuit_sub(in261, in8); 
let t1150 = circuit_mul(t1143, t1149); 
let t1151 = circuit_sub(in261, in8); 
...
let t1156 = circuit_sub(in261, in9); 
let t1157 = circuit_mul(t1150, t1156); 
let t1158 = circuit_sub(in261, in9); 
...
let t1163 = circuit_sub(in261, in10); 
let t1164 = circuit_mul(t1157, t1163); 
let t1165 = circuit_sub(in261, in10); 
...
let t1170 = circuit_sub(in261, in11); 
let t1171 = circuit_mul(t1164, t1170); 
let t1172 = circuit_sub(in261, in11); 
...
let t1177 = circuit_sub(in261, in12); 
let t1178 = circuit_mul(t1171, t1177); 
let t1179 = circuit_sub(in261, in12); 
...
let t1184 = circuit_sub(in261, in13); 
let t1185 = circuit_mul(t1178, t1184); 
let t1186 = circuit_sub(in261, in13); 
...
let t1191 = circuit_sub(in261, in14); 
let t1192 = circuit_mul(t1185, t1191); 
let t1193 = circuit_sub(in261, in14); 
...
let t1199 = circuit_sub(in279, in0); 
let t1200 = circuit_mul(in261, t1199); 
...
let t1207 = circuit_mul(t1134, in288); 
let t1208 = circuit_sub(in262, in7); 
let t1209 = circuit_mul(in0, t1208); 
let t1210 = circuit_sub(in262, in7); 
...
let t1215 = circuit_sub(in262, in0); 
let t1216 = circuit_mul(t1209, t1215); 
let t1217 = circuit_sub(in262, in0); 
...
let t1222 = circuit_sub(in262, in8); 
let t1223 = circuit_mul(t1216, t1222); 
let t1224 = circuit_sub(in262, in8); 
...
let t1229 = circuit_sub(in262, in9); 
let t1230 = circuit_mul(t1223, t1229); 
let t1231 = circuit_sub(in262, in9); 
...
let t1236 = circuit_sub(in262, in10); 
let t1237 = circuit_mul(t1230, t1236); 
let t1238 = circuit_sub(in262, in10); 
...
let t1243 = circuit_sub(in262, in11); 
let t1244 = circuit_mul(t1237, t1243); 
let t1245 = circuit_sub(in262, in11); 
...
let t1250 = circuit_sub(in262, in12); 
let t1251 = circuit_mul(t1244, t1250); 
let t1252 = circuit_sub(in262, in12); 
...
let t1257 = circuit_sub(in262, in13); 
let t1258 = circuit_mul(t1251, t1257); 
let t1259 = circuit_sub(in262, in13); 
...
let t1264 = circuit_sub(in262, in14); 
let t1265 = circuit_mul(t1258, t1264); 
let t1266 = circuit_sub(in262, in14); 
...
let t1272 = circuit_sub(in280, in0); 
let t1273 = circuit_mul(in262, t1272); 
let t1274 = circuit_add(in0, t1273); 
let t1275 = circuit_mul(t1202, t1274); 
let t1276 = circuit_add(in188, in189); 
let t1277 = circuit_sub(t1276, t1271); 
let t1278 = circuit_mul(t1277, t1207); 
let t1279 = circuit_add(t1206, t1278); 
let t1280 = circuit_mul(t1207, in288); 
let t1281 = circuit_sub(in263, in7); 
let t1282 = circuit_mul(in0, t1281); 
let t1283 = circuit_sub(in263, in7); 
let t1284 = circuit_mul(in2, t1283); 
let t1285 = circuit_inverse(t1284); 
let t1286 = circuit_mul(in188, t1285); 
let t1287 = circuit_add(in7, t1286); 
let t1288 = circuit_sub(in263, in0); 
let t1289 = circuit_mul(t1282, t1288); 
let t1290 = circuit_sub(in263, in0); 
let t1291 = circuit_mul(in3, t1290); 
let t1292 = circuit_inverse(t1291); 
let t1293 = circuit_mul(in189, t1292); 
let t1294 = circuit_add(t1287, t1293); 
let t1295 = circuit_sub(in263, in8); 
let t1296 = circuit_mul(t1289, t1295); 
let t1297 = circuit_sub(in263, in8); 
let t1298 = circuit_mul(in4, t1297); 
let t1299 = circuit_inverse(t1298); 
let t1300 = circuit_mul(in190, t1299); 
let t1301 = circuit_add(t1294, t1300); 
let t1302 = circuit_sub(in263, in9); 
let t1303 = circuit_mul(t1296, t1302); 
let t1304 = circuit_sub(in263, in9); 
let t1305 = circuit_mul(in5, t1304); 
let t1306 = circuit_inverse(t1305); 
let t1307 = circuit_mul(in191, t1306); 
let t1308 = circuit_add(t1301, t1307); 
let t1309 = circuit_sub(in263, in10); 
let t1310 = circuit_mul(t1303, t1309); 
let t1311 = circuit_sub(in263, in10); 
let t1312 = circuit_mul(in6, t1311); 
let t1313 = circuit_inverse(t1312); 
let t1314 = circuit_mul(in192, t1313); 
let t1315 = circuit_add(t1308, t1314); 
let t1316 = circuit_sub(in263, in11); 
let t1317 = circuit_mul(t1310, t1316); 
let t1318 = circuit_sub(in263, in11); 
let t1319 = circuit_mul(in5, t1318); 
let t1320 = circuit_inverse(t1319); 
let t1321 = circuit_mul(in193, t1320); 
let t1322 = circuit_add(t1315, t1321); 
let t1323 = circuit_sub(in263, in12); 
let t1324 = circuit_mul(t1317, t1323); 
let t1325 = circuit_sub(in263, in12); 
let t1326 = circuit_mul(in4, t1325); 
let t1327 = circuit_inverse(t1326); 
let t1328 = circuit_mul(in194, t1327); 
let t1329 = circuit_add(t1322, t1328); 
let t1330 = circuit_sub(in263, in13); 
let t1331 = circuit_mul(t1324, t1330); 
let t1332 = circuit_sub(in263, in13); 
let t1333 = circuit_mul(in3, t1332); 
let t1334 = circuit_inverse(t1333); 
let t1335 = circuit_mul(in195, t1334); 
let t1336 = circuit_add(t1329, t1335); 
let t1337 = circuit_sub(in263, in14); 
let t1338 = circuit_mul(t1331, t1337); 
let t1339 = circuit_sub(in263, in14); 
let t1340 = circuit_mul(in2, t1339); 
let t1341 = circuit_inverse(t1340); 
let t1342 = circuit_mul(in196, t1341); 
let t1343 = circuit_add(t1336, t1342); 
let t1344 = circuit_mul(t1343, t1338); 
let t1345 = circuit_sub(in281, in0); 
let t1346 = circuit_mul(in263, t1345); 
let t1347 = circuit_add(in0, t1346); 
let t1348 = circuit_mul(t1275, t1347); 
let t1349 = circuit_add(in197, in198); 
let t1350 = circuit_sub(t1349, t1344); 
let t1351 = circuit_mul(t1350, t1280); 
let t1352 = circuit_add(t1279, t1351); 
let t1353 = circuit_sub(in264, in7); 
let t1354 = circuit_mul(in0, t1353); 
let t1355 = circuit_sub(in264, in7); 
let t1356 = circuit_mul(in2, t1355); 
let t1357 = circuit_inverse(t1356); 
let t1358 = circuit_mul(in197, t1357); 
let t1359 = circuit_add(in7, t1358); 
let t1360 = circuit_sub(in264, in0); 
let t1361 = circuit_mul(t1354, t1360); 
let t1362 = circuit_sub(in264, in0); 
let t1363 = circuit_mul(in3, t1362); 
let t1364 = circuit_inverse(t1363); 
let t1365 = circuit_mul(in198, t1364); 
let t1366 = circuit_add(t1359, t1365); 
let t1367 = circuit_sub(in264, in8); 
let t1368 = circuit_mul(t1361, t1367); 
let t1369 = circuit_sub(in264, in8); 
let t1370 = circuit_mul(in4, t1369); 
let t1371 = circuit_inverse(t1370); 
let t1372 = circuit_mul(in199, t1371); 
let t1373 = circuit_add(t1366, t1372); 
let t1374 = circuit_sub(in264, in9); 
let t1375 = circuit_mul(t1368, t1374); 
let t1376 = circuit_sub(in264, in9); 
let t1377 = circuit_mul(in5, t1376); 
let t1378 = circuit_inverse(t1377); 
let t1379 = circuit_mul(in200, t1378); 
let t1380 = circuit_add(t1373, t1379); 
let t1381 = circuit_sub(in264, in10); 
let t1382 = circuit_mul(t1375, t1381); 
let t1383 = circuit_sub(in264, in10); 
let t1384 = circuit_mul(in6, t1383); 
let t1385 = circuit_inverse(t1384); 
let t1386 = circuit_mul(in201, t1385); 
let t1387 = circuit_add(t1380, t1386); 
let t1388 = circuit_sub(in264, in11); 
let t1389 = circuit_mul(t1382, t1388); 
let t1390 = circuit_sub(in264, in11); 
let t1391 = circuit_mul(in5, t1390); 
let t1392 = circuit_inverse(t1391); 
let t1393 = circuit_mul(in202, t1392); 
let t1394 = circuit_add(t1387, t1393); 
let t1395 = circuit_sub(in264, in12); 
let t1396 = circuit_mul(t1389, t1395); 
let t1397 = circuit_sub(in264, in12); 
let t1398 = circuit_mul(in4, t1397); 
let t1399 = circuit_inverse(t1398); 
let t1400 = circuit_mul(in203, t1399); 
let t1401 = circuit_add(t1394, t1400); 
let t1402 = circuit_sub(in264, in13); 
let t1403 = circuit_mul(t1396, t1402); 
let t1404 = circuit_sub(in264, in13); 
let t1405 = circuit_mul(in3, t1404); 
let t1406 = circuit_inverse(t1405); 
let t1407 = circuit_mul(in204, t1406); 
let t1408 = circuit_add(t1401, t1407); 
let t1409 = circuit_sub(in264, in14); 
let t1410 = circuit_mul(t1403, t1409); 
let t1411 = circuit_sub(in264, in14); 
let t1412 = circuit_mul(in2, t1411); 
let t1413 = circuit_inverse(t1412); 
let t1414 = circuit_mul(in205, t1413); 
let t1415 = circuit_add(t1408, t1414); 
let t1416 = circuit_mul(t1415, t1410); 
let t1417 = circuit_sub(in282, in0); 
let t1418 = circuit_mul(in264, t1417); 
let t1419 = circuit_add(in0, t1418); 
let t1420 = circuit_mul(t1348, t1419); 
let t1421 = circuit_sub(in213, in9); 
let t1422 = circuit_mul(t1421, in206); 
let t1423 = circuit_mul(t1422, in234); 
let t1424 = circuit_mul(t1423, in233); 
let t1425 = circuit_mul(t1424, in15); 
let t1426 = circuit_mul(in208, in233); 
let t1427 = circuit_mul(in209, in234); 
let t1428 = circuit_mul(in210, in235); 
let t1429 = circuit_mul(in211, in236); 
let t1430 = circuit_add(t1425, t1426); 
let t1431 = circuit_add(t1430, t1427); 
let t1432 = circuit_add(t1431, t1428); 
let t1433 = circuit_add(t1432, t1429); 
let t1434 = circuit_add(t1433, in207); 
let t1435 = circuit_sub(in213, in0); 
let t1436 = circuit_mul(t1435, in244); 
let t1437 = circuit_add(t1434, t1436); 
let t1438 = circuit_mul(t1437, in213); 
let t1439 = circuit_mul(t1438, t1420); 
let t1440 = circuit_add(in233, in236); 
let t1441 = circuit_add(t1440, in206); 
let t1442 = circuit_sub(t1441, in241); 
let t1443 = circuit_sub(in213, in8); 
let t1444 = circuit_mul(t1442, t1443); 
let t1445 = circuit_sub(in213, in0); 
let t1446 = circuit_mul(t1444, t1445); 
let t1447 = circuit_mul(t1446, in213); 
let t1448 = circuit_mul(t1447, t1420); 
let t1449 = circuit_mul(in223, in286); 
let t1450 = circuit_add(in233, t1449); 
let t1451 = circuit_add(t1450, in287); 
let t1452 = circuit_mul(in224, in286); 
let t1453 = circuit_add(in234, t1452); 
let t1454 = circuit_add(t1453, in287); 
let t1455 = circuit_mul(t1451, t1454); 
let t1456 = circuit_mul(in225, in286); 
let t1457 = circuit_add(in235, t1456); 
let t1458 = circuit_add(t1457, in287); 
let t1459 = circuit_mul(t1455, t1458); 
let t1460 = circuit_mul(in226, in286); 
let t1461 = circuit_add(in236, t1460); 
let t1462 = circuit_add(t1461, in287); 
let t1463 = circuit_mul(t1459, t1462); 
let t1464 = circuit_mul(in219, in286); 
let t1465 = circuit_add(in233, t1464); 
let t1466 = circuit_add(t1465, in287); 
let t1467 = circuit_mul(in220, in286); 
let t1468 = circuit_add(in234, t1467); 
let t1469 = circuit_add(t1468, in287); 
let t1470 = circuit_mul(t1466, t1469); 
let t1471 = circuit_mul(in221, in286); 
let t1472 = circuit_add(in235, t1471); 
let t1473 = circuit_add(t1472, in287); 
let t1474 = circuit_mul(t1470, t1473); 
let t1475 = circuit_mul(in222, in286); 
let t1476 = circuit_add(in236, t1475); 
let t1477 = circuit_add(t1476, in287); 
let t1478 = circuit_mul(t1474, t1477); 
let t1479 = circuit_add(in237, in231); 
let t1480 = circuit_mul(t1463, t1479); 
let t1481 = circuit_mul(in232, t107); 
let t1482 = circuit_add(in245, t1481); 
let t1483 = circuit_mul(t1478, t1482); 
let t1484 = circuit_sub(t1480, t1483); 
let t1485 = circuit_mul(t1484, t1420); 
let t1486 = circuit_mul(in232, in245); 
let t1487 = circuit_mul(t1486, t1420); 
let t1488 = circuit_mul(in228, in283); 
let t1489 = circuit_mul(in229, in284); 
let t1490 = circuit_mul(in230, in285); 
let t1491 = circuit_add(in227, in287); 
let t1492 = circuit_add(t1491, t1488); 
let t1493 = circuit_add(t1492, t1489); 
let t1494 = circuit_add(t1493, t1490); 
let t1495 = circuit_mul(in209, in241); 
let t1496 = circuit_add(in233, in287); 
let t1497 = circuit_add(t1496, t1495); 
let t1498 = circuit_mul(in206, in242); 
let t1499 = circuit_add(in234, t1498); 
let t1500 = circuit_mul(in207, in243); 
let t1501 = circuit_add(in235, t1500); 
let t1502 = circuit_mul(t1499, in283); 
let t1503 = circuit_mul(t1501, in284); 
let t1504 = circuit_mul(in210, in285); 
let t1505 = circuit_add(t1497, t1502); 
let t1506 = circuit_add(t1505, t1503); 
let t1507 = circuit_add(t1506, t1504); 
let t1508 = circuit_mul(in238, t1494); 
let t1509 = circuit_mul(in238, t1507); 
let t1510 = circuit_add(in240, in212); 
let t1511 = circuit_mul(in240, in212); 
let t1512 = circuit_sub(t1510, t1511); 
let t1513 = circuit_mul(t1507, t1494); 
let t1514 = circuit_mul(t1513, in238); 
let t1515 = circuit_sub(t1514, t1512); 
let t1516 = circuit_mul(t1515, t1420); 
let t1517 = circuit_mul(in212, t1508); 
let t1518 = circuit_mul(in239, t1509); 
let t1519 = circuit_sub(t1517, t1518); 
let t1520 = circuit_mul(in214, t1420); 
let t1521 = circuit_sub(in234, in233); 
let t1522 = circuit_sub(in235, in234); 
let t1523 = circuit_sub(in236, in235); 
let t1524 = circuit_sub(in241, in236); 
let t1525 = circuit_add(t1521, in16); 
let t1526 = circuit_add(t1525, in16); 
let t1527 = circuit_add(t1526, in16); 
let t1528 = circuit_mul(t1521, t1525); 
let t1529 = circuit_mul(t1528, t1526); 
let t1530 = circuit_mul(t1529, t1527); 
let t1531 = circuit_mul(t1530, t1520); 
let t1532 = circuit_add(t1522, in16); 
let t1533 = circuit_add(t1532, in16); 
let t1534 = circuit_add(t1533, in16); 
let t1535 = circuit_mul(t1522, t1532); 
let t1536 = circuit_mul(t1535, t1533); 
let t1537 = circuit_mul(t1536, t1534); 
let t1538 = circuit_mul(t1537, t1520); 
let t1539 = circuit_add(t1523, in16); 
let t1540 = circuit_add(t1539, in16); 
let t1541 = circuit_add(t1540, in16); 
let t1542 = circuit_mul(t1523, t1539); 
let t1543 = circuit_mul(t1542, t1540); 
let t1544 = circuit_mul(t1543, t1541); 
let t1545 = circuit_mul(t1544, t1520); 
let t1546 = circuit_add(t1524, in16); 
let t1547 = circuit_add(t1546, in16); 
let t1548 = circuit_add(t1547, in16); 
let t1549 = circuit_mul(t1524, t1546); 
let t1550 = circuit_mul(t1549, t1547); 
let t1551 = circuit_mul(t1550, t1548); 
let t1552 = circuit_mul(t1551, t1520); 
let t1553 = circuit_sub(in241, in234); 
let t1554 = circuit_mul(in235, in235); 
let t1555 = circuit_mul(in244, in244); 
let t1556 = circuit_mul(in235, in244); 
let t1557 = circuit_mul(t1556, in208); 
let t1558 = circuit_add(in242, in241); 
let t1559 = circuit_add(t1558, in234); 
let t1560 = circuit_mul(t1559, t1553); 
let t1561 = circuit_mul(t1560, t1553); 
let t1562 = circuit_sub(t1561, t1555); 
let t1563 = circuit_sub(t1562, t1554); 
let t1564 = circuit_add(t1563, t1557); 
let t1565 = circuit_add(t1564, t1557); 
let t1566 = circuit_sub(in0, in206); 
let t1567 = circuit_mul(t1565, t1420); 
let t1568 = circuit_mul(t1567, in215); 
let t1569 = circuit_mul(t1568, t1566); 
let t1570 = circuit_add(in235, in243); 
let t1571 = circuit_mul(in244, in208); 
let t1572 = circuit_sub(t1571, in235); 
let t1573 = circuit_mul(t1570, t1553); 
let t1574 = circuit_sub(in242, in234); 
let t1575 = circuit_mul(t1574, t1572); 
let t1576 = circuit_add(t1573, t1575); 
let t1577 = circuit_mul(t1576, t1420); 
let t1578 = circuit_mul(t1577, in215); 
let t1579 = circuit_mul(t1578, t1566); 
let t1580 = circuit_add(t1554, in17); 
let t1581 = circuit_mul(t1580, in234); 
let t1582 = circuit_add(t1554, t1554); 
let t1583 = circuit_add(t1582, t1582); 
let t1584 = circuit_mul(t1581, in18); 
let t1585 = circuit_add(in242, in234); 
let t1586 = circuit_add(t1585, in234); 
let t1587 = circuit_mul(t1586, t1583); 
let t1588 = circuit_sub(t1587, t1584); 
let t1589 = circuit_mul(t1588, t1420); 
let t1590 = circuit_mul(t1589, in215); 
let t1591 = circuit_mul(t1590, in206); 
let t1592 = circuit_add(t1569, t1591); 
let t1593 = circuit_add(in234, in234); 
let t1594 = circuit_add(t1593, in234); 
let t1595 = circuit_mul(t1594, in234); 
let t1596 = circuit_sub(in234, in242); 
let t1597 = circuit_mul(t1595, t1596); 
let t1598 = circuit_add(in235, in235); 
let t1599 = circuit_add(in235, in243); 
let t1600 = circuit_mul(t1598, t1599); 
let t1601 = circuit_sub(t1597, t1600); 
let t1602 = circuit_mul(t1601, t1420); 
let t1603 = circuit_mul(t1602, in215); 
let t1604 = circuit_mul(t1603, in206); 
let t1605 = circuit_add(t1579, t1604); 
let t1606 = circuit_mul(in233, in242); 
let t1607 = circuit_mul(in241, in234); 
let t1608 = circuit_add(t1606, t1607); 
let t1609 = circuit_mul(in233, in236); 
let t1610 = circuit_mul(in234, in235); 
let t1611 = circuit_add(t1609, t1610); 
let t1612 = circuit_sub(t1611, in243); 
let t1613 = circuit_mul(t1612, in19); 
let t1614 = circuit_sub(t1613, in244); 
let t1615 = circuit_add(t1614, t1608); 
let t1616 = circuit_mul(t1615, in211); 
let t1617 = circuit_mul(t1608, in19); 
let t1618 = circuit_mul(in241, in242); 
let t1619 = circuit_add(t1617, t1618); 
let t1620 = circuit_add(in235, in236); 
let t1621 = circuit_sub(t1619, t1620); 
let t1622 = circuit_mul(t1621, in210); 
let t1623 = circuit_add(t1619, in236); 
let t1624 = circuit_add(in243, in244); 
let t1625 = circuit_sub(t1623, t1624); 
let t1626 = circuit_mul(t1625, in206); 
let t1627 = circuit_add(t1622, t1616); 
let t1628 = circuit_add(t1627, t1626); 
let t1629 = circuit_mul(t1628, in209); 
let t1630 = circuit_mul(in242, in20); 
let t1631 = circuit_add(t1630, in241); 
let t1632 = circuit_mul(t1631, in20); 
let t1633 = circuit_add(t1632, in235); 
let t1634 = circuit_mul(t1633, in20); 
let t1635 = circuit_add(t1634, in234); 
let t1636 = circuit_mul(t1635, in20); 
let t1637 = circuit_add(t1636, in233); 
let t1638 = circuit_sub(t1637, in236); 
let t1639 = circuit_mul(t1638, in211); 
let t1640 = circuit_mul(in243, in20); 
let t1641 = circuit_add(t1640, in242); 
let t1642 = circuit_mul(t1641, in20); 
let t1643 = circuit_add(t1642, in241); 
let t1644 = circuit_mul(t1643, in20); 
let t1645 = circuit_add(t1644, in236); 
let t1646 = circuit_mul(t1645, in20); 
let t1647 = circuit_add(t1646, in235); 
let t1648 = circuit_sub(t1647, in244); 
let t1649 = circuit_mul(t1648, in206); 
let t1650 = circuit_add(t1639, t1649); 
let t1651 = circuit_mul(t1650, in210); 
let t1652 = circuit_mul(in235, in285); 
let t1653 = circuit_mul(in234, in284); 
let t1654 = circuit_mul(in233, in283); 
let t1655 = circuit_add(t1652, t1653); 
let t1656 = circuit_add(t1655, t1654); 
let t1657 = circuit_add(t1656, in207); 
let t1658 = circuit_sub(t1657, in236); 
let t1659 = circuit_sub(in241, in233); 
let t1660 = circuit_sub(in244, in236); 
let t1661 = circuit_mul(t1659, t1659); 
let t1662 = circuit_sub(t1661, t1659); 
let t1663 = circuit_sub(in7, t1659); 
let t1664 = circuit_add(t1663, in0); 
let t1665 = circuit_mul(t1664, t1660); 
let t1666 = circuit_mul(in208, in209); 
let t1667 = circuit_mul(t1666, in216); 
let t1668 = circuit_mul(t1667, t1420); 
let t1669 = circuit_mul(t1665, t1668); 
let t1670 = circuit_mul(t1662, t1668); 
let t1671 = circuit_mul(t1658, t1666); 
let t1672 = circuit_sub(in236, t1657); 
let t1673 = circuit_mul(t1672, t1672); 
let t1674 = circuit_sub(t1673, t1672); 
let t1675 = circuit_mul(in243, in285); 
let t1676 = circuit_mul(in242, in284); 
let t1677 = circuit_mul(in241, in283); 
let t1678 = circuit_add(t1675, t1676); 
let t1679 = circuit_add(t1678, t1677); 
let t1680 = circuit_sub(in244, t1679); 
let t1681 = circuit_sub(in243, in235); 
let t1682 = circuit_sub(in7, t1659); 
let t1683 = circuit_add(t1682, in0); 
let t1684 = circuit_sub(in7, t1680); 
let t1685 = circuit_add(t1684, in0); 
let t1686 = circuit_mul(t1681, t1685); 
let t1687 = circuit_mul(t1683, t1686); 
let t1688 = circuit_mul(t1680, t1680); 
let t1689 = circuit_sub(t1688, t1680); 
let t1690 = circuit_mul(in213, in216); 
let t1691 = circuit_mul(t1690, t1420); 
let t1692 = circuit_mul(t1687, t1691); 
let t1693 = circuit_mul(t1662, t1691); 
let t1694 = circuit_mul(t1689, t1691); 
let t1695 = circuit_mul(t1674, in213); 
let t1696 = circuit_sub(in242, in234); 
let t1697 = circuit_sub(in7, t1659); 
let t1698 = circuit_add(t1697, in0); 
let t1699 = circuit_mul(t1698, t1696); 
let t1700 = circuit_sub(t1699, in235); 
let t1701 = circuit_mul(t1700, in211); 
let t1702 = circuit_mul(t1701, in208); 
let t1703 = circuit_add(t1671, t1702); 
let t1704 = circuit_mul(t1658, in206); 
let t1705 = circuit_mul(t1704, in208); 
let t1706 = circuit_add(t1703, t1705); 
let t1707 = circuit_add(t1706, t1695); 
let t1708 = circuit_add(t1707, t1629); 
let t1709 = circuit_add(t1708, t1651); 
let t1710 = circuit_mul(t1709, in216); 
let t1711 = circuit_mul(t1710, t1420); 
let t1712 = circuit_add(in233, in208); 
let t1713 = circuit_add(in234, in209); 
let t1714 = circuit_add(in235, in210); 
let t1715 = circuit_add(in236, in211); 
let t1716 = circuit_mul(t1712, t1712); 
let t1717 = circuit_mul(t1716, t1716); 
let t1718 = circuit_mul(t1717, t1712); 
let t1719 = circuit_mul(t1713, t1713); 
let t1720 = circuit_mul(t1719, t1719); 
let t1721 = circuit_mul(t1720, t1713); 
let t1722 = circuit_mul(t1714, t1714); 
let t1723 = circuit_mul(t1722, t1722); 
let t1724 = circuit_mul(t1723, t1714); 
let t1725 = circuit_mul(t1715, t1715); 
let t1726 = circuit_mul(t1725, t1725); 
let t1727 = circuit_mul(t1726, t1715); 
let t1728 = circuit_add(t1718, t1721); 
let t1729 = circuit_add(t1724, t1727); 
let t1730 = circuit_add(t1721, t1721); 
let t1731 = circuit_add(t1730, t1729); 
let t1732 = circuit_add(t1727, t1727); 
let t1733 = circuit_add(t1732, t1728); 
let t1734 = circuit_add(t1729, t1729); 
let t1735 = circuit_add(t1734, t1734); 
let t1736 = circuit_add(t1735, t1733); 
let t1737 = circuit_add(t1728, t1728); 
let t1738 = circuit_add(t1737, t1737); 
let t1739 = circuit_add(t1738, t1731); 
let t1740 = circuit_add(t1733, t1739); 
let t1741 = circuit_add(t1731, t1736); 
let t1742 = circuit_mul(in217, t1420); 
let t1743 = circuit_sub(t1740, in241); 
let t1744 = circuit_mul(t1742, t1743); 
let t1745 = circuit_sub(t1739, in242); 
let t1746 = circuit_mul(t1742, t1745); 
let t1747 = circuit_sub(t1741, in243); 
let t1748 = circuit_mul(t1742, t1747); 
let t1749 = circuit_sub(t1736, in244); 
let t1750 = circuit_mul(t1742, t1749); 
let t1751 = circuit_add(in233, in208); 
let t1752 = circuit_mul(t1751, t1751); 
let t1753 = circuit_mul(t1752, t1752); 
let t1754 = circuit_mul(t1753, t1751); 
let t1755 = circuit_add(t1754, in234); 
let t1756 = circuit_add(t1755, in235); 
let t1757 = circuit_add(t1756, in236); 
let t1758 = circuit_mul(in218, t1420); 
let t1759 = circuit_mul(t1754, in21); 
let t1760 = circuit_add(t1759, t1757); 
let t1761 = circuit_sub(t1760, in241); 
let t1762 = circuit_mul(t1758, t1761); 
let t1763 = circuit_mul(in234, in22); 
let t1764 = circuit_add(t1763, t1757); 
let t1765 = circuit_sub(t1764, in242); 
let t1766 = circuit_mul(t1758, t1765); 
let t1767 = circuit_mul(in235, in23); 
let t1768 = circuit_add(t1767, t1757); 
let t1769 = circuit_sub(t1768, in243); 
let t1770 = circuit_mul(t1758, t1769); 
let t1771 = circuit_mul(in236, in24); 
let t1772 = circuit_add(t1771, t1757); 
let t1773 = circuit_sub(t1772, in244); 
let t1774 = circuit_mul(t1758, t1773); 
let t1775 = circuit_mul(t1448, in289); 
let t1776 = circuit_add(t1439, t1775); 
let t1777 = circuit_mul(t1485, in290); 
let t1778 = circuit_add(t1776, t1777); 
let t1779 = circuit_mul(t1487, in291); 
let t1780 = circuit_add(t1778, t1779); 
let t1781 = circuit_mul(t1516, in292); 
let t1782 = circuit_add(t1780, t1781); 
let t1783 = circuit_mul(t1519, in293); 
let t1784 = circuit_add(t1782, t1783); 
let t1785 = circuit_mul(t1531, in294); 
let t1786 = circuit_add(t1784, t1785); 
let t1787 = circuit_mul(t1538, in295); 
let t1788 = circuit_add(t1786, t1787); 
let t1789 = circuit_mul(t1545, in296); 
let t1790 = circuit_add(t1788, t1789); 
let t1791 = circuit_mul(t1552, in297); 
let t1792 = circuit_add(t1790, t1791); 
let t1793 = circuit_mul(t1592, in298); 
let t1794 = circuit_add(t1792, t1793); 
let t1795 = circuit_mul(t1605, in299); 
let t1796 = circuit_add(t1794, t1795); 
let t1797 = circuit_mul(t1711, in300); 
let t1798 = circuit_add(t1796, t1797); 
let t1799 = circuit_mul(t1669, in301); 
let t1800 = circuit_add(t1798, t1799); 
let t1801 = circuit_mul(t1670, in302); 
let t1802 = circuit_add(t1800, t1801); 
let t1803 = circuit_mul(t1692, in303); 
let t1804 = circuit_add(t1802, t1803); 
let t1805 = circuit_mul(t1693, in304); 
let t1806 = circuit_add(t1804, t1805); 
let t1807 = circuit_mul(t1694, in305); 
let t1808 = circuit_add(t1806, t1807); 
let t1809 = circuit_mul(t1744, in306); 
let t1810 = circuit_add(t1808, t1809); 
let t1811 = circuit_mul(t1746, in307); 
let t1812 = circuit_add(t1810, t1811); 
let t1813 = circuit_mul(t1748, in308); 
let t1814 = circuit_add(t1812, t1813); 
let t1815 = circuit_mul(t1750, in309); 
let t1816 = circuit_add(t1814, t1815); 
let t1817 = circuit_mul(t1762, in310); 
let t1818 = circuit_add(t1816, t1817); 
let t1819 = circuit_mul(t1766, in311); 
let t1820 = circuit_add(t1818, t1819); 
let t1821 = circuit_mul(t1770, in312); 
let t1822 = circuit_add(t1820, t1821); 
let t1823 = circuit_mul(t1774, in313); 
let t1824 = circuit_add(t1822, t1823); 
let t1825 = circuit_mul(in0, in249); 
let t1826 = circuit_mul(t1825, in250); 
let t1827 = circuit_mul(t1826, in251); 
let t1828 = circuit_mul(t1827, in252); 
let t1829 = circuit_mul(t1828, in253); 
let t1830 = circuit_mul(t1829, in254); 
let t1831 = circuit_mul(t1830, in255); 
let t1832 = circuit_mul(t1831, in256); 
let t1833 = circuit_mul(t1832, in257); 
let t1834 = circuit_mul(t1833, in258); 
let t1835 = circuit_mul(t1834, in259); 
let t1836 = circuit_mul(t1835, in260); 
let t1837 = circuit_mul(t1836, in261); 
let t1838 = circuit_mul(t1837, in262); 
let t1839 = circuit_mul(t1838, in263); 
let t1840 = circuit_mul(t1839, in264); 
let t1841 = circuit_sub(in0, t1840); 
let t1842 = circuit_mul(t1824, t1841); 
let t1843 = circuit_mul(in246, in314); 
let t1844 = circuit_add(t1842, t1843); 
let t1845 = circuit_sub(t1844, t1416); 

let modulus = modulus;

    let mut circuit_inputs = (t1352,t1845,).new_inputs();
    // Prefill constants:
    
            circuit_inputs = circuit_inputs.next_span(ZK_HONK_SUMCHECK_SIZE_18_PUB_17_GRUMPKIN_CONSTANTS.span()); // in0 - in24
...
circuit_inputs = circuit_inputs.next_2(libra_evaluation); // in246
...
let scalar_29:u384 = outputs.get_output(t677);
let scalar_30:u384 = outputs.get_output(t678);
let scalar_31:u384 = outputs.get_output(t679);
let scalar_32:u384 = outputs.get_output(t680);
let scalar_33:u384 = outputs.get_output(t681);
let scalar_34:u384 = outputs.get_output(t157);
let scalar_35:u384 = outputs.get_output(t161);
let scalar_36:u384 = outputs.get_output(t165);
let scalar_42:u384 = outputs.get_output(t381);
let scalar_43:u384 = outputs.get_output(t396);
let scalar_44:u384 = outputs.get_output(t411);
let scalar_45:u384 = outputs.get_output(t426);
let scalar_46:u384 = outputs.get_output(t441);
let scalar_47:u384 = outputs.get_output(t456);
let scalar_48:u384 = outputs.get_output(t471);
let scalar_49:u384 = outputs.get_output(t486);
let scalar_50:u384 = outputs.get_output(t501);
let scalar_51:u384 = outputs.get_output(t516);
let scalar_52:u384 = outputs.get_output(t531);
let scalar_53:u384 = outputs.get_output(t546);
let scalar_54:u384 = outputs.get_output(t561);
let scalar_55:u384 = outputs.get_output(t576);
let scalar_56:u384 = outputs.get_output(t591);
let scalar_57:u384 = outputs.get_output(t606);
let scalar_58:u384 = outputs.get_output(t621);
let scalar_69:u384 = outputs.get_output(t658);
let scalar_70:u384 = outputs.get_output(t676);
let scalar_71:u384 = outputs.get_output(t673);
let scalar_72:u384 = outputs.get_output(t675);return (scalar_1,scalar_2,scalar_3,scalar_4,scalar_5,scalar_6,scalar_7,scalar_8,scalar_9,scalar_10,scalar_11,scalar_12,scalar_13,scalar_14,scalar_15,scalar_16,scalar_17,scalar_18,scalar_19,scalar_20,scalar_21,scalar_22,scalar_23,scalar_24,scalar_25,scalar_26,scalar_27,scalar_28,scalar_29,scalar_30,scalar_31,scalar_32,scalar_33,scalar_34,scalar_35,scalar_36,scalar_42,scalar_43,scalar_44,scalar_45,scalar_46,scalar_47,scalar_48,scalar_49,scalar_50,scalar_51,scalar_52,scalar_53,scalar_54,scalar_55,scalar_56,scalar_57,scalar_58,scalar_69,scalar_70,scalar_71,scalar_72);
}#[inline(always)]
pub fn run_GRUMPKIN_ZK_HONK_EVALS_CONS_INIT_SIZE_18_circuit(tp_gemini_r:u384, modulus:CircuitModulus)->(u384,u384) {
...
pub fn run_GRUMPKIN_ZK_HONK_EVALS_CONS_LOOP_SIZE_18_circuit(challenge_poly_eval:u384,root_power_times_tp_gemini_r:u384,tp_sumcheck_u_challenge:u384, modulus:CircuitModulus)->(u384,u384) {
...
pub fn run_GRUMPKIN_ZK_HONK_EVALS_CONS_DONE_SIZE_18_circuit(p_libra_evaluation:u384,p_libra_poly_evals:Span<u256>,tp_gemini_r:u384,challenge_poly_eval:u384,root_power_times_tp_gemini_r:u384, modulus:CircuitModulus)->(u384,u384) {
...
pub fn run_BN254_EVAL_FN_CHALLENGE_SING_58P_RLC_circuit<T, +IntoCircuitInputValue<T>, +Drop<T>, +Copy<T>>(A:G1Point,coeff:u384,SumDlogDivBatched:FunctionFelt<T>, modulus:CircuitModulus)->(u384,) {
 ...
 // INPUT stack
	 ...
	 let in252 = CE::<CI<252>> {};
let t0 = circuit_mul(in63, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
let t1 = circuit_add(in62, t0); // Eval sumdlogdiv_a_num Horner step: add coefficient_59
let t2 = circuit_mul(t1, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
let t3 = circuit_add(in61, t2); // Eval sumdlogdiv_a_num Horner step: add coefficient_58
let t4 = circuit_mul(t3, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
let t5 = circuit_add(in60, t4); // Eval sumdlogdiv_a_num Horner step: add coefficient_57
let t6 = circuit_mul(t5, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
let t7 = circuit_add(in59, t6); // Eval sumdlogdiv_a_num Horner step: add coefficient_56
let t8 = circuit_mul(t7, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
let t9 = circuit_add(in58, t8); // Eval sumdlogdiv_a_num Horner step: add coefficient_55
let t10 = circuit_mul(t9, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
let t11 = circuit_add(in57, t10); // Eval sumdlogdiv_a_num Horner step: add coefficient_54
let t12 = circuit_mul(t11, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
let t13 = circuit_add(in56, t12); // Eval sumdlogdiv_a_num Horner step: add coefficient_53
let t14 = circuit_mul(t13, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
let t15 = circuit_add(in55, t14); // Eval sumdlogdiv_a_num Horner step: add coefficient_52
let t16 = circuit_mul(t15, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
let t17 = circuit_add(in54, t16); // Eval sumdlogdiv_a_num Horner step: add coefficient_51
let t18 = circuit_mul(t17, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
let t19 = circuit_add(in53, t18); // Eval sumdlogdiv_a_num Horner step: add coefficient_50
let t20 = circuit_mul(t19, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
let t21 = circuit_add(in52, t20); // Eval sumdlogdiv_a_num Horner step: add coefficient_49
let t22 = circuit_mul(t21, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
let t23 = circuit_add(in51, t22); // Eval sumdlogdiv_a_num Horner step: add coefficient_48
let t24 = circuit_mul(t23, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
let t25 = circuit_add(in50, t24); // Eval sumdlogdiv_a_num Horner step: add coefficient_47
let t26 = circuit_mul(t25, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
let t27 = circuit_add(in49, t26); // Eval sumdlogdiv_a_num Horner step: add coefficient_46
let t28 = circuit_mul(t27, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
let t29 = circuit_add(in48, t28); // Eval sumdlogdiv_a_num Horner step: add coefficient_45
let t30 = circuit_mul(t29, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
let t31 = circuit_add(in47, t30); // Eval sumdlogdiv_a_num Horner step: add coefficient_44
let t32 = circuit_mul(t31, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
let t33 = circuit_add(in46, t32); // Eval sumdlogdiv_a_num Horner step: add coefficient_43
let t34 = circuit_mul(t33, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
let t35 = circuit_add(in45, t34); // Eval sumdlogdiv_a_num Horner step: add coefficient_42
let t36 = circuit_mul(t35, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
let t37 = circuit_add(in44, t36); // Eval sumdlogdiv_a_num Horner step: add coefficient_41
let t38 = circuit_mul(t37, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
let t39 = circuit_add(in43, t38); // Eval sumdlogdiv_a_num Horner step: add coefficient_40
let t40 = circuit_mul(t39, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
let t41 = circuit_add(in42, t40); // Eval sumdlogdiv_a_num Horner step: add coefficient_39
let t42 = circuit_mul(t41, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
let t43 = circuit_add(in41, t42); // Eval sumdlogdiv_a_num Horner step: add coefficient_38
let t44 = circuit_mul(t43, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
let t45 = circuit_add(in40, t44); // Eval sumdlogdiv_a_num Horner step: add coefficient_37
let t46 = circuit_mul(t45, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
let t47 = circuit_add(in39, t46); // Eval sumdlogdiv_a_num Horner step: add coefficient_36
let t48 = circuit_mul(t47, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
let t49 = circuit_add(in38, t48); // Eval sumdlogdiv_a_num Horner step: add coefficient_35
let t50 = circuit_mul(t49, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
let t51 = circuit_add(in37, t50); // Eval sumdlogdiv_a_num Horner step: add coefficient_34
let t52 = circuit_mul(t51, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
let t53 = circuit_add(in36, t52); // Eval sumdlogdiv_a_num Horner step: add coefficient_33
let t54 = circuit_mul(t53, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
let t55 = circuit_add(in35, t54); // Eval sumdlogdiv_a_num Horner step: add coefficient_32
let t56 = circuit_mul(t55, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
let t57 = circuit_add(in34, t56); // Eval sumdlogdiv_a_num Horner step: add coefficient_31
let t58 = circuit_mul(t57, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
let t59 = circuit_add(in33, t58); // Eval sumdlogdiv_a_num Horner step: add coefficient_30
let t60 = circuit_mul(t59, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
let t61 = circuit_add(in32, t60); // Eval sumdlogdiv_a_num Horner step: add coefficient_29
let t62 = circuit_mul(t61, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
let t63 = circuit_add(in31, t62); // Eval sumdlogdiv_a_num Horner step: add coefficient_28
let t64 = circuit_mul(t63, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
let t65 = circuit_add(in30, t64); // Eval sumdlogdiv_a_num Horner step: add coefficient_27
let t66 = circuit_mul(t65, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
let t67 = circuit_add(in29, t66); // Eval sumdlogdiv_a_num Horner step: add coefficient_26
let t68 = circuit_mul(t67, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
let t69 = circuit_add(in28, t68); // Eval sumdlogdiv_a_num Horner step: add coefficient_25
let t70 = circuit_mul(t69, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
let t71 = circuit_add(in27, t70); // Eval sumdlogdiv_a_num Horner step: add coefficient_24
let t72 = circuit_mul(t71, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
let t73 = circuit_add(in26, t72); // Eval sumdlogdiv_a_num Horner step: add coefficient_23
let t74 = circuit_mul(t73, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
let t75 = circuit_add(in25, t74); // Eval sumdlogdiv_a_num Horner step: add coefficient_22
let t76 = circuit_mul(t75, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
let t77 = circuit_add(in24, t76); // Eval sumdlogdiv_a_num Horner step: add coefficient_21
let t78 = circuit_mul(t77, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
let t79 = circuit_add(in23, t78); // Eval sumdlogdiv_a_num Horner step: add coefficient_20
let t80 = circuit_mul(t79, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
let t81 = circuit_add(in22, t80); // Eval sumdlogdiv_a_num Horner step: add coefficient_19
let t82 = circuit_mul(t81, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
let t83 = circuit_add(in21, t82); // Eval sumdlogdiv_a_num Horner step: add coefficient_18
let t84 = circuit_mul(t83, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
let t85 = circuit_add(in20, t84); // Eval sumdlogdiv_a_num Horner step: add coefficient_17
let t86 = circuit_mul(t85, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
let t87 = circuit_add(in19, t86); // Eval sumdlogdiv_a_num Horner step: add coefficient_16
let t88 = circuit_mul(t87, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
let t89 = circuit_add(in18, t88); // Eval sumdlogdiv_a_num Horner step: add coefficient_15
let t90 = circuit_mul(t89, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
let t91 = circuit_add(in17, t90); // Eval sumdlogdiv_a_num Horner step: add coefficient_14
let t92 = circuit_mul(t91, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
let t93 = circuit_add(in16, t92); // Eval sumdlogdiv_a_num Horner step: add coefficient_13
let t94 = circuit_mul(t93, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
let t95 = circuit_add(in15, t94); // Eval sumdlogdiv_a_num Horner step: add coefficient_12
let t96 = circuit_mul(t95, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
let t97 = circuit_add(in14, t96); // Eval sumdlogdiv_a_num Horner step: add coefficient_11
let t98 = circuit_mul(t97, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
let t99 = circuit_add(in13, t98); // Eval sumdlogdiv_a_num Horner step: add coefficient_10
let t100 = circuit_mul(t99, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
let t101 = circuit_add(in12, t100); // Eval sumdlogdiv_a_num Horner step: add coefficient_9
let t102 = circuit_mul(t101, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
let t103 = circuit_add(in11, t102); // Eval sumdlogdiv_a_num Horner step: add coefficient_8
let t104 = circuit_mul(t103, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
let t105 = circuit_add(in10, t104); // Eval sumdlogdiv_a_num Horner step: add coefficient_7
let t106 = circuit_mul(t105, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
let t107 = circuit_add(in9, t106); // Eval sumdlogdiv_a_num Horner step: add coefficient_6
let t108 = circuit_mul(t107, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
let t109 = circuit_add(in8, t108); // Eval sumdlogdiv_a_num Horner step: add coefficient_5
let t110 = circuit_mul(t109, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
let t111 = circuit_add(in7, t110); // Eval sumdlogdiv_a_num Horner step: add coefficient_4
let t112 = circuit_mul(t111, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
let t113 = circuit_add(in6, t112); // Eval sumdlogdiv_a_num Horner step: add coefficient_3
let t114 = circuit_mul(t113, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
let t115 = circuit_add(in5, t114); // Eval sumdlogdiv_a_num Horner step: add coefficient_2
let t116 = circuit_mul(t115, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
let t117 = circuit_add(in4, t116); // Eval sumdlogdiv_a_num Horner step: add coefficient_1
let t118 = circuit_mul(t117, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
let t119 = circuit_add(in3, t118); // Eval sumdlogdiv_a_num Horner step: add coefficient_0
let t120 = circuit_mul(in125, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
let t121 = circuit_add(in124, t120); // Eval sumdlogdiv_a_den Horner step: add coefficient_60
let t122 = circuit_mul(t121, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
let t123 = circuit_add(in123, t122); // Eval sumdlogdiv_a_den Horner step: add coefficient_59
let t124 = circuit_mul(t123, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
let t125 = circuit_add(in122, t124); // Eval sumdlogdiv_a_den Horner step: add coefficient_58
let t126 = circuit_mul(t125, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
let t127 = circuit_add(in121, t126); // Eval sumdlogdiv_a_den Horner step: add coefficient_57
let t128 = circuit_mul(t127, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
let t129 = circuit_add(in120, t128); // Eval sumdlogdiv_a_den Horner step: add coefficient_56
let t130 = circuit_mul(t129, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
let t131 = circuit_add(in119, t130); // Eval sumdlogdiv_a_den Horner step: add coefficient_55
let t132 = circuit_mul(t131, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
let t133 = circuit_add(in118, t132); // Eval sumdlogdiv_a_den Horner step: add coefficient_54
let t134 = circuit_mul(t133, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
let t135 = circuit_add(in117, t134); // Eval sumdlogdiv_a_den Horner step: add coefficient_53
let t136 = circuit_mul(t135, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
let t137 = circuit_add(in116, t136); // Eval sumdlogdiv_a_den Horner step: add coefficient_52
let t138 = circuit_mul(t137, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
let t139 = circuit_add(in115, t138); // Eval sumdlogdiv_a_den Horner step: add coefficient_51
let t140 = circuit_mul(t139, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
let t141 = circuit_add(in114, t140); // Eval sumdlogdiv_a_den Horner step: add coefficient_50
let t142 = circuit_mul(t141, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
let t143 = circuit_add(in113, t142); // Eval sumdlogdiv_a_den Horner step: add coefficient_49
let t144 = circuit_mul(t143, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
let t145 = circuit_add(in112, t144); // Eval sumdlogdiv_a_den Horner step: add coefficient_48
let t146 = circuit_mul(t145, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
let t147 = circuit_add(in111, t146); // Eval sumdlogdiv_a_den Horner step: add coefficient_47
let t148 = circuit_mul(t147, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
let t149 = circuit_add(in110, t148); // Eval sumdlogdiv_a_den Horner step: add coefficient_46
let t150 = circuit_mul(t149, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
let t151 = circuit_add(in109, t150); // Eval sumdlogdiv_a_den Horner step: add coefficient_45
let t152 = circuit_mul(t151, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
let t153 = circuit_add(in108, t152); // Eval sumdlogdiv_a_den Horner step: add coefficient_44
let t154 = circuit_mul(t153, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
let t155 = circuit_add(in107, t154); // Eval sumdlogdiv_a_den Horner step: add coefficient_43
let t156 = circuit_mul(t155, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
let t157 = circuit_add(in106, t156); // Eval sumdlogdiv_a_den Horner step: add coefficient_42
let t158 = circuit_mul(t157, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
let t159 = circuit_add(in105, t158); // Eval sumdlogdiv_a_den Horner step: add coefficient_41
let t160 = circuit_mul(t159, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
let t161 = circuit_add(in104, t160); // Eval sumdlogdiv_a_den Horner step: add coefficient_40
let t162 = circuit_mul(t161, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
let t163 = circuit_add(in103, t162); // Eval sumdlogdiv_a_den Horner step: add coefficient_39
let t164 = circuit_mul(t163, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
let t165 = circuit_add(in102, t164); // Eval sumdlogdiv_a_den Horner step: add coefficient_38
let t166 = circuit_mul(t165, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
let t167 = circuit_add(in101, t166); // Eval sumdlogdiv_a_den Horner step: add coefficient_37
let t168 = circuit_mul(t167, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
let t169 = circuit_add(in100, t168); // Eval sumdlogdiv_a_den Horner step: add coefficient_36
let t170 = circuit_mul(t169, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
let t171 = circuit_add(in99, t170); // Eval sumdlogdiv_a_den Horner step: add coefficient_35
let t172 = circuit_mul(t171, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
let t173 = circuit_add(in98, t172); // Eval sumdlogdiv_a_den Horner step: add coefficient_34
let t174 = circuit_mul(t173, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
let t175 = circuit_add(in97, t174); // Eval sumdlogdiv_a_den Horner step: add coefficient_33
let t176 = circuit_mul(t175, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
let t177 = circuit_add(in96, t176); // Eval sumdlogdiv_a_den Horner step: add coefficient_32
let t178 = circuit_mul(t177, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
let t179 = circuit_add(in95, t178); // Eval sumdlogdiv_a_den Horner step: add coefficient_31
let t180 = circuit_mul(t179, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
let t181 = circuit_add(in94, t180); // Eval sumdlogdiv_a_den Horner step: add coefficient_30
let t182 = circuit_mul(t181, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
let t183 = circuit_add(in93, t182); // Eval sumdlogdiv_a_den Horner step: add coefficient_29
let t184 = circuit_mul(t183, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
let t185 = circuit_add(in92, t184); // Eval sumdlogdiv_a_den Horner step: add coefficient_28
let t186 = circuit_mul(t185, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
let t187 = circuit_add(in91, t186); // Eval sumdlogdiv_a_den Horner step: add coefficient_27
let t188 = circuit_mul(t187, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
let t189 = circuit_add(in90, t188); // Eval sumdlogdiv_a_den Horner step: add coefficient_26
let t190 = circuit_mul(t189, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
let t191 = circuit_add(in89, t190); // Eval sumdlogdiv_a_den Horner step: add coefficient_25
let t192 = circuit_mul(t191, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
let t193 = circuit_add(in88, t192); // Eval sumdlogdiv_a_den Horner step: add coefficient_24
let t194 = circuit_mul(t193, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
let t195 = circuit_add(in87, t194); // Eval sumdlogdiv_a_den Horner step: add coefficient_23
let t196 = circuit_mul(t195, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
let t197 = circuit_add(in86, t196); // Eval sumdlogdiv_a_den Horner step: add coefficient_22
let t198 = circuit_mul(t197, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
let t199 = circuit_add(in85, t198); // Eval sumdlogdiv_a_den Horner step: add coefficient_21
let t200 = circuit_mul(t199, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
let t201 = circuit_add(in84, t200); // Eval sumdlogdiv_a_den Horner step: add coefficient_20
let t202 = circuit_mul(t201, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
let t203 = circuit_add(in83, t202); // Eval sumdlogdiv_a_den Horner step: add coefficient_19
let t204 = circuit_mul(t203, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
let t205 = circuit_add(in82, t204); // Eval sumdlogdiv_a_den Horner step: add coefficient_18
let t206 = circuit_mul(t205, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
let t207 = circuit_add(in81, t206); // Eval sumdlogdiv_a_den Horner step: add coefficient_17
let t208 = circuit_mul(t207, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
let t209 = circuit_add(in80, t208); // Eval sumdlogdiv_a_den Horner step: add coefficient_16
let t210 = circuit_mul(t209, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
let t211 = circuit_add(in79, t210); // Eval sumdlogdiv_a_den Horner step: add coefficient_15
let t212 = circuit_mul(t211, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
let t213 = circuit_add(in78, t212); // Eval sumdlogdiv_a_den Horner step: add coefficient_14
let t214 = circuit_mul(t213, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
let t215 = circuit_add(in77, t214); // Eval sumdlogdiv_a_den Horner step: add coefficient_13
let t216 = circuit_mul(t215, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
let t217 = circuit_add(in76, t216); // Eval sumdlogdiv_a_den Horner step: add coefficient_12
let t218 = circuit_mul(t217, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
let t219 = circuit_add(in75, t218); // Eval sumdlogdiv_a_den Horner step: add coefficient_11
let t220 = circuit_mul(t219, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
let t221 = circuit_add(in74, t220); // Eval sumdlogdiv_a_den Horner step: add coefficient_10
let t222 = circuit_mul(t221, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
let t223 = circuit_add(in73, t222); // Eval sumdlogdiv_a_den Horner step: add coefficient_9
let t224 = circuit_mul(t223, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
let t225 = circuit_add(in72, t224); // Eval sumdlogdiv_a_den Horner step: add coefficient_8
let t226 = circuit_mul(t225, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
let t227 = circuit_add(in71, t226); // Eval sumdlogdiv_a_den Horner step: add coefficient_7
let t228 = circuit_mul(t227, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
let t229 = circuit_add(in70, t228); // Eval sumdlogdiv_a_den Horner step: add coefficient_6
let t230 = circuit_mul(t229, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
let t231 = circuit_add(in69, t230); // Eval sumdlogdiv_a_den Horner step: add coefficient_5
let t232 = circuit_mul(t231, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
let t233 = circuit_add(in68, t232); // Eval sumdlogdiv_a_den Horner step: add coefficient_4
let t234 = circuit_mul(t233, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
let t235 = circuit_add(in67, t234); // Eval sumdlogdiv_a_den Horner step: add coefficient_3
let t236 = circuit_mul(t235, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
let t237 = circuit_add(in66, t236); // Eval sumdlogdiv_a_den Horner step: add coefficient_2
let t238 = circuit_mul(t237, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
let t239 = circuit_add(in65, t238); // Eval sumdlogdiv_a_den Horner step: add coefficient_1
let t240 = circuit_mul(t239, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
let t241 = circuit_add(in64, t240); // Eval sumdlogdiv_a_den Horner step: add coefficient_0
let t242 = circuit_inverse(t241); 
let t243 = circuit_mul(t119, t242); 
let t244 = circuit_mul(in187, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
let t245 = circuit_add(in186, t244); // Eval sumdlogdiv_b_num Horner step: add coefficient_60
let t246 = circuit_mul(t245, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
let t247 = circuit_add(in185, t246); // Eval sumdlogdiv_b_num Horner step: add coefficient_59
let t248 = circuit_mul(t247, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
let t249 = circuit_add(in184, t248); // Eval sumdlogdiv_b_num Horner step: add coefficient_58
let t250 = circuit_mul(t249, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
let t251 = circuit_add(in183, t250); // Eval sumdlogdiv_b_num Horner step: add coefficient_57
let t252 = circuit_mul(t251, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
let t253 = circuit_add(in182, t252); // Eval sumdlogdiv_b_num Horner step: add coefficient_56
let t254 = circuit_mul(t253, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
let t255 = circuit_add(in181, t254); // Eval sumdlogdiv_b_num Horner step: add coefficient_55
let t256 = circuit_mul(t255, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
let t257 = circuit_add(in180, t256); // Eval sumdlogdiv_b_num Horner step: add coefficient_54
let t258 = circuit_mul(t257, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
let t259 = circuit_add(in179, t258); // Eval sumdlogdiv_b_num Horner step: add coefficient_53
let t260 = circuit_mul(t259, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
let t261 = circuit_add(in178, t260); // Eval sumdlogdiv_b_num Horner step: add coefficient_52
let t262 = circuit_mul(t261, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
let t263 = circuit_add(in177, t262); // Eval sumdlogdiv_b_num Horner step: add coefficient_51
let t264 = circuit_mul(t263, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
let t265 = circuit_add(in176, t264); // Eval sumdlogdiv_b_num Horner step: add coefficient_50
let t266 = circuit_mul(t265, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
let t267 = circuit_add(in175, t266); // Eval sumdlogdiv_b_num Horner step: add coefficient_49
let t268 = circuit_mul(t267, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
let t269 = circuit_add(in174, t268); // Eval sumdlogdiv_b_num Horner step: add coefficient_48
let t270 = circuit_mul(t269, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
let t271 = circuit_add(in173, t270); // Eval sumdlogdiv_b_num Horner step: add coefficient_47
let t272 = circuit_mul(t271, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
let t273 = circuit_add(in172, t272); // Eval sumdlogdiv_b_num Horner step: add coefficient_46
let t274 = circuit_mul(t273, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
let t275 = circuit_add(in171, t274); // Eval sumdlogdiv_b_num Horner step: add coefficient_45
let t276 = circuit_mul(t275, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
let t277 = circuit_add(in170, t276); // Eval sumdlogdiv_b_num Horner step: add coefficient_44
let t278 = circuit_mul(t277, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
let t279 = circuit_add(in169, t278); // Eval sumdlogdiv_b_num Horner step: add coefficient_43
let t280 = circuit_mul(t279, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
let t281 = circuit_add(in168, t280); // Eval sumdlogdiv_b_num Horner step: add coefficient_42
let t282 = circuit_mul(t281, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
let t283 = circuit_add(in167, t282); // Eval sumdlogdiv_b_num Horner step: add coefficient_41
let t284 = circuit_mul(t283, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
let t285 = circuit_add(in166, t284); // Eval sumdlogdiv_b_num Horner step: add coefficient_40
let t286 = circuit_mul(t285, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
let t287 = circuit_add(in165, t286); // Eval sumdlogdiv_b_num Horner step: add coefficient_39
let t288 = circuit_mul(t287, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
let t289 = circuit_add(in164, t288); // Eval sumdlogdiv_b_num Horner step: add coefficient_38
let t290 = circuit_mul(t289, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
let t291 = circuit_add(in163, t290); // Eval sumdlogdiv_b_num Horner step: add coefficient_37
let t292 = circuit_mul(t291, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
let t293 = circuit_add(in162, t292); // Eval sumdlogdiv_b_num Horner step: add coefficient_36
let t294 = circuit_mul(t293, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
let t295 = circuit_add(in161, t294); // Eval sumdlogdiv_b_num Horner step: add coefficient_35
let t296 = circuit_mul(t295, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
let t297 = circuit_add(in160, t296); // Eval sumdlogdiv_b_num Horner step: add coefficient_34
let t298 = circuit_mul(t297, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
let t299 = circuit_add(in159, t298); // Eval sumdlogdiv_b_num Horner step: add coefficient_33
let t300 = circuit_mul(t299, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
let t301 = circuit_add(in158, t300); // Eval sumdlogdiv_b_num Horner step: add coefficient_32
let t302 = circuit_mul(t301, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
let t303 = circuit_add(in157, t302); // Eval sumdlogdiv_b_num Horner step: add coefficient_31
let t304 = circuit_mul(t303, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
let t305 = circuit_add(in156, t304); // Eval sumdlogdiv_b_num Horner step: add coefficient_30
let t306 = circuit_mul(t305, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
let t307 = circuit_add(in155, t306); // Eval sumdlogdiv_b_num Horner step: add coefficient_29
let t308 = circuit_mul(t307, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
let t309 = circuit_add(in154, t308); // Eval sumdlogdiv_b_num Horner step: add coefficient_28
let t310 = circuit_mul(t309, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
let t311 = circuit_add(in153, t310); // Eval sumdlogdiv_b_num Horner step: add coefficient_27
let t312 = circuit_mul(t311, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
let t313 = circuit_add(in152, t312); // Eval sumdlogdiv_b_num Horner step: add coefficient_26
let t314 = circuit_mul(t313, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
let t315 = circuit_add(in151, t314); // Eval sumdlogdiv_b_num Horner step: add coefficient_25
let t316 = circuit_mul(t315, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
let t317 = circuit_add(in150, t316); // Eval sumdlogdiv_b_num Horner step: add coefficient_24
let t318 = circuit_mul(t317, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
let t319 = circuit_add(in149, t318); // Eval sumdlogdiv_b_num Horner step: add coefficient_23
let t320 = circuit_mul(t319, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
let t321 = circuit_add(in148, t320); // Eval sumdlogdiv_b_num Horner step: add coefficient_22
let t322 = circuit_mul(t321, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
let t323 = circuit_add(in147, t322); // Eval sumdlogdiv_b_num Horner step: add coefficient_21
let t324 = circuit_mul(t323, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
let t325 = circuit_add(in146, t324); // Eval sumdlogdiv_b_num Horner step: add coefficient_20
let t326 = circuit_mul(t325, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
let t327 = circuit_add(in145, t326); // Eval sumdlogdiv_b_num Horner step: add coefficient_19
let t328 = circuit_mul(t327, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
let t329 = circuit_add(in144, t328); // Eval sumdlogdiv_b_num Horner step: add coefficient_18
let t330 = circuit_mul(t329, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
let t331 = circuit_add(in143, t330); // Eval sumdlogdiv_b_num Horner step: add coefficient_17
let t332 = circuit_mul(t331, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
let t333 = circuit_add(in142, t332); // Eval sumdlogdiv_b_num Horner step: add coefficient_16
let t334 = circuit_mul(t333, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
let t335 = circuit_add(in141, t334); // Eval sumdlogdiv_b_num Horner step: add coefficient_15
let t336 = circuit_mul(t335, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
let t337 = circuit_add(in140, t336); // Eval sumdlogdiv_b_num Horner step: add coefficient_14
let t338 = circuit_mul(t337, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
let t339 = circuit_add(in139, t338); // Eval sumdlogdiv_b_num Horner step: add coefficient_13
let t340 = circuit_mul(t339, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
let t341 = circuit_add(in138, t340); // Eval sumdlogdiv_b_num Horner step: add coefficient_12
let t342 = circuit_mul(t341, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
let t343 = circuit_add(in137, t342); // Eval sumdlogdiv_b_num Horner step: add coefficient_11
let t344 = circuit_mul(t343, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
let t345 = circuit_add(in136, t344); // Eval sumdlogdiv_b_num Horner step: add coefficient_10
let t346 = circuit_mul(t345, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
let t347 = circuit_add(in135, t346); // Eval sumdlogdiv_b_num Horner step: add coefficient_9
let t348 = circuit_mul(t347, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
let t349 = circuit_add(in134, t348); // Eval sumdlogdiv_b_num Horner step: add coefficient_8
let t350 = circuit_mul(t349, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
let t351 = circuit_add(in133, t350); // Eval sumdlogdiv_b_num Horner step: add coefficient_7
let t352 = circuit_mul(t351, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
let t353 = circuit_add(in132, t352); // Eval sumdlogdiv_b_num Horner step: add coefficient_6
let t354 = circuit_mul(t353, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
let t355 = circuit_add(in131, t354); // Eval sumdlogdiv_b_num Horner step: add coefficient_5
let t356 = circuit_mul(t355, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
let t357 = circuit_add(in130, t356); // Eval sumdlogdiv_b_num Horner step: add coefficient_4
let t358 = circuit_mul(t357, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
let t359 = circuit_add(in129, t358); // Eval sumdlogdiv_b_num Horner step: add coefficient_3
let t360 = circuit_mul(t359, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
let t361 = circuit_add(in128, t360); // Eval sumdlogdiv_b_num Horner step: add coefficient_2
let t362 = circuit_mul(t361, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
let t363 = circuit_add(in127, t362); // Eval sumdlogdiv_b_num Horner step: add coefficient_1
let t364 = circuit_mul(t363, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
let t365 = circuit_add(in126, t364); // Eval sumdlogdiv_b_num Horner step: add coefficient_0
let t366 = circuit_mul(in252, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
let t367 = circuit_add(in251, t366); // Eval sumdlogdiv_b_den Horner step: add coefficient_63
let t368 = circuit_mul(t367, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
let t369 = circuit_add(in250, t368); // Eval sumdlogdiv_b_den Horner step: add coefficient_62
let t370 = circuit_mul(t369, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
let t371 = circuit_add(in249, t370); // Eval sumdlogdiv_b_den Horner step: add coefficient_61
let t372 = circuit_mul(t371, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
let t373 = circuit_add(in248, t372); // Eval sumdlogdiv_b_den Horner step: add coefficient_60
let t374 = circuit_mul(t373, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
let t375 = circuit_add(in247, t374); // Eval sumdlogdiv_b_den Horner step: add coefficient_59
let t376 = circuit_mul(t375, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
let t377 = circuit_add(in246, t376); // Eval sumdlogdiv_b_den Horner step: add coefficient_58
let t378 = circuit_mul(t377, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
let t379 = circuit_add(in245, t378); // Eval sumdlogdiv_b_den Horner step: add coefficient_57
let t380 = circuit_mul(t379, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
let t381 = circuit_add(in244, t380); // Eval sumdlogdiv_b_den Horner step: add coefficient_56
let t382 = circuit_mul(t381, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
let t383 = circuit_add(in243, t382); // Eval sumdlogdiv_b_den Horner step: add coefficient_55
let t384 = circuit_mul(t383, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
let t385 = circuit_add(in242, t384); // Eval sumdlogdiv_b_den Horner step: add coefficient_54
let t386 = circuit_mul(t385, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
let t387 = circuit_add(in241, t386); // Eval sumdlogdiv_b_den Horner step: add coefficient_53
let t388 = circuit_mul(t387, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
let t389 = circuit_add(in240, t388); // Eval sumdlogdiv_b_den Horner step: add coefficient_52
let t390 = circuit_mul(t389, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
let t391 = circuit_add(in239, t390); // Eval sumdlogdiv_b_den Horner step: add coefficient_51
let t392 = circuit_mul(t391, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
let t393 = circuit_add(in238, t392); // Eval sumdlogdiv_b_den Horner step: add coefficient_50
let t394 = circuit_mul(t393, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
let t395 = circuit_add(in237, t394); // Eval sumdlogdiv_b_den Horner step: add coefficient_49
let t396 = circuit_mul(t395, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
let t397 = circuit_add(in236, t396); // Eval sumdlogdiv_b_den Horner step: add coefficient_48
let t398 = circuit_mul(t397, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
let t399 = circuit_add(in235, t398); // Eval sumdlogdiv_b_den Horner step: add coefficient_47
let t400 = circuit_mul(t399, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
let t401 = circuit_add(in234, t400); // Eval sumdlogdiv_b_den Horner step: add coefficient_46
let t402 = circuit_mul(t401, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
let t403 = circuit_add(in233, t402); // Eval sumdlogdiv_b_den Horner step: add coefficient_45
let t404 = circuit_mul(t403, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
let t405 = circuit_add(in232, t404); // Eval sumdlogdiv_b_den Horner step: add coefficient_44
let t406 = circuit_mul(t405, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
let t407 = circuit_add(in231, t406); // Eval sumdlogdiv_b_den Horner step: add coefficient_43
let t408 = circuit_mul(t407, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
let t409 = circuit_add(in230, t408); // Eval sumdlogdiv_b_den Horner step: add coefficient_42
let t410 = circuit_mul(t409, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
let t411 = circuit_add(in229, t410); // Eval sumdlogdiv_b_den Horner step: add coefficient_41
let t412 = circuit_mul(t411, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
let t413 = circuit_add(in228, t412); // Eval sumdlogdiv_b_den Horner step: add coefficient_40
let t414 = circuit_mul(t413, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
let t415 = circuit_add(in227, t414); // Eval sumdlogdiv_b_den Horner step: add coefficient_39
let t416 = circuit_mul(t415, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
let t417 = circuit_add(in226, t416); // Eval sumdlogdiv_b_den Horner step: add coefficient_38
let t418 = circuit_mul(t417, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
let t419 = circuit_add(in225, t418); // Eval sumdlogdiv_b_den Horner step: add coefficient_37
let t420 = circuit_mul(t419, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
let t421 = circuit_add(in224, t420); // Eval sumdlogdiv_b_den Horner step: add coefficient_36
let t422 = circuit_mul(t421, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
let t423 = circuit_add(in223, t422); // Eval sumdlogdiv_b_den Horner step: add coefficient_35
let t424 = circuit_mul(t423, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
let t425 = circuit_add(in222, t424); // Eval sumdlogdiv_b_den Horner step: add coefficient_34
let t426 = circuit_mul(t425, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
let t427 = circuit_add(in221, t426); // Eval sumdlogdiv_b_den Horner step: add coefficient_33
let t428 = circuit_mul(t427, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
let t429 = circuit_add(in220, t428); // Eval sumdlogdiv_b_den Horner step: add coefficient_32
let t430 = circuit_mul(t429, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
let t431 = circuit_add(in219, t430); // Eval sumdlogdiv_b_den Horner step: add coefficient_31
let t432 = circuit_mul(t431, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
let t433 = circuit_add(in218, t432); // Eval sumdlogdiv_b_den Horner step: add coefficient_30
let t434 = circuit_mul(t433, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
let t435 = circuit_add(in217, t434); // Eval sumdlogdiv_b_den Horner step: add coefficient_29
let t436 = circuit_mul(t435, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
let t437 = circuit_add(in216, t436); // Eval sumdlogdiv_b_den Horner step: add coefficient_28
let t438 = circuit_mul(t437, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
let t439 = circuit_add(in215, t438); // Eval sumdlogdiv_b_den Horner step: add coefficient_27
let t440 = circuit_mul(t439, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
let t441 = circuit_add(in214, t440); // Eval sumdlogdiv_b_den Horner step: add coefficient_26
let t442 = circuit_mul(t441, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
let t443 = circuit_add(in213, t442); // Eval sumdlogdiv_b_den Horner step: add coefficient_25
let t444 = circuit_mul(t443, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
let t445 = circuit_add(in212, t444); // Eval sumdlogdiv_b_den Horner step: add coefficient_24
let t446 = circuit_mul(t445, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
let t447 = circuit_add(in211, t446); // Eval sumdlogdiv_b_den Horner step: add coefficient_23
let t448 = circuit_mul(t447, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
let t449 = circuit_add(in210, t448); // Eval sumdlogdiv_b_den Horner step: add coefficient_22
let t450 = circuit_mul(t449, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
let t451 = circuit_add(in209, t450); // Eval sumdlogdiv_b_den Horner step: add coefficient_21
let t452 = circuit_mul(t451, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
let t453 = circuit_add(in208, t452); // Eval sumdlogdiv_b_den Horner step: add coefficient_20
let t454 = circuit_mul(t453, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
let t455 = circuit_add(in207, t454); // Eval sumdlogdiv_b_den Horner step: add coefficient_19
let t456 = circuit_mul(t455, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
let t457 = circuit_add(in206, t456); // Eval sumdlogdiv_b_den Horner step: add coefficient_18
let t458 = circuit_mul(t457, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
let t459 = circuit_add(in205, t458); // Eval sumdlogdiv_b_den Horner step: add coefficient_17
let t460 = circuit_mul(t459, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
let t461 = circuit_add(in204, t460); // Eval sumdlogdiv_b_den Horner step: add coefficient_16
let t462 = circuit_mul(t461, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
let t463 = circuit_add(in203, t462); // Eval sumdlogdiv_b_den Horner step: add coefficient_15
let t464 = circuit_mul(t463, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
let t465 = circuit_add(in202, t464); // Eval sumdlogdiv_b_den Horner step: add coefficient_14
let t466 = circuit_mul(t465, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
let t467 = circuit_add(in201, t466); // Eval sumdlogdiv_b_den Horner step: add coefficient_13
let t468 = circuit_mul(t467, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
let t469 = circuit_add(in200, t468); // Eval sumdlogdiv_b_den Horner step: add coefficient_12
let t470 = circuit_mul(t469, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
let t471 = circuit_add(in199, t470); // Eval sumdlogdiv_b_den Horner step: add coefficient_11
let t472 = circuit_mul(t471, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
let t473 = circuit_add(in198, t472); // Eval sumdlogdiv_b_den Horner step: add coefficient_10
let t474 = circuit_mul(t473, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
let t475 = circuit_add(in197, t474); // Eval sumdlogdiv_b_den Horner step: add coefficient_9
let t476 = circuit_mul(t475, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
let t477 = circuit_add(in196, t476); // Eval sumdlogdiv_b_den Horner step: add coefficient_8
let t478 = circuit_mul(t477, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
let t479 = circuit_add(in195, t478); // Eval sumdlogdiv_b_den Horner step: add coefficient_7
let t480 = circuit_mul(t479, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
let t481 = circuit_add(in194, t480); // Eval sumdlogdiv_b_den Horner step: add coefficient_6
let t482 = circuit_mul(t481, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
let t483 = circuit_add(in193, t482); // Eval sumdlogdiv_b_den Horner step: add coefficient_5
let t484 = circuit_mul(t483, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
let t485 = circuit_add(in192, t484); // Eval sumdlogdiv_b_den Horner step: add coefficient_4
let t486 = circuit_mul(t485, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
let t487 = circuit_add(in191, t486); // Eval sumdlogdiv_b_den Horner step: add coefficient_3
let t488 = circuit_mul(t487, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
let t489 = circuit_add(in190, t488); // Eval sumdlogdiv_b_den Horner step: add coefficient_2
let t490 = circuit_mul(t489, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
let t491 = circuit_add(in189, t490); // Eval sumdlogdiv_b_den Horner step: add coefficient_1
let t492 = circuit_mul(t491, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
let t493 = circuit_add(in188, t492); // Eval sumdlogdiv_b_den Horner step: add coefficient_0
let t494 = circuit_inverse(t493); 
let t495 = circuit_mul(t365, t494); 
let t496 = circuit_mul(in1, t495); 
let t497 = circuit_add(t243, t496); 
let t498 = circuit_mul(in2, t497); 

let modulus = modulus;

    let mut circuit_inputs = (t498,).new_inputs();
    // Prefill constants:
...
circuit_inputs = circuit_inputs.next_2(coeff); // in2
        ...
        let outputs = circuit_inputs.done_2().eval(modulus).unwrap();
let res:u384 = outputs.get_output(t498);return (res,);
}
