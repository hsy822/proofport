...
pub fn run_BN254_EVAL_FN_CHALLENGE_SING_53P_RLC_circuit<T, +IntoCircuitInputValue<T>, +Drop<T>, +Copy<T>>(A:G1Point,coeff:u384,SumDlogDivBatched:FunctionFelt<T>, modulus:CircuitModulus)->(u384,) {
...
circuit_inputs = circuit_inputs.next_2(coeff); // in2
        ...
        let outputs = circuit_inputs.done_2().eval(modulus).unwrap();
let res:u384 = outputs.get_output(t458);return (res,);
}
