...
use super::honk_verifier_circuits::{run_GRUMPKIN_HONK_SUMCHECK_SIZE_12_PUB_17_circuit, run_GRUMPKIN_HONK_PREP_MSM_SCALARS_SIZE_12_circuit, run_BN254_EVAL_FN_CHALLENGE_SING_48P_RLC_circuit, is_on_curve_bn254};
...
mod UltraKeccakHonkVerifier {
    ...
    use super::{vk, VK_HASH, precomputed_lines, run_GRUMPKIN_HONK_SUMCHECK_SIZE_12_PUB_17_circuit, run_GRUMPKIN_HONK_PREP_MSM_SCALARS_SIZE_12_circuit, run_BN254_EVAL_FN_CHALLENGE_SING_48P_RLC_circuit, is_on_curve_bn254};
